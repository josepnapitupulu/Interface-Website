        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('forms2.updateBaptis', $baptis['nik']) }}" method="POST">
              @csrf
              @method('PUT')
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="baptis" name="cTanggalBaptis" value="{{ $baptis['tanggal_Baptis'] }}" placeholder="Tanggal Baptis">
                  </div>
                  <div class="form-group">
