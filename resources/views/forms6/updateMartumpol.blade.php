      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">lc2
              ...
              <!-- form start -->
              <form action="{{ route('forms6.updateMartumpol', $martumpol['ID']) }}" method="POST">
                @csrf
                  @method('PUT')
                    <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="exampleInputText" name="cTanggalMartumpol" value="{{ $nikahs['tanggal_pernikahan'] }}" placeholder="Tanggal Nikah">
                      </div>
                      <div class="form-group">
